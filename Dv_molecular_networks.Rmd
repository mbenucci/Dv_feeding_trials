...
# FROM HERE! Need to add rarefaction curves and NMDS for eDNA plus kick samples analysis.
...
raref.edna_inext = iNEXT(raref.edna, q=c(0,1), datatype = "abundance", se=T, endpoint=150)
