...
fa = dva %>% mutate(trial_id = factor(trial_id, levels=c("DvA0","DvA4","DvA8","DvA12","DvA24","DvA36"))) %>% mutate(trial_repl = factor(trial_repl, levels=c("control","1","2","4"))) %>%
...
fd = dvd %>% mutate(trial_id = factor(trial_id, levels=c("DvD0","DvD4","DvD8","DvD12","DvD24","DvD36"))) %>% mutate(trial_repl = factor(trial_repl, levels=c("control","1","2","4"))) %>%
...
fc = dvc %>% mutate(trial_id = factor(trial_id, levels=c("DvG0","DvG4","DvG8","DvG12","DvG24","DvG36"))) %>% mutate(trial_repl = factor(trial_repl, levels=c("control","1","2","4"))) %>%
