...
col.network=c("yellow","yellow","red","tan4","cyan3","yellow","cyan3","cyan3","darkorchid3","red","cyan3")
```

```{r legend order}
name.multi=c("Cladocera","Amphipoda","Diptera","Mollusca","Oligochaeta")
col.multi=c("cyan3","red","yellow","darkorchid3","tan4")
```
