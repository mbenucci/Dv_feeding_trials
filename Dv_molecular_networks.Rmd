...
text(3,0, label="eDNA", cex=2.5)
text(-3,2.7, label="guts", cex=2.5)
text(2,-3, label="kick", cex=2.5)
...
final.melt[grep("Eudiaptomus|Eurytemora", final.melt$variable),"order"] = "Calanoida"
final.melt[grep("Chaetonotus", final.melt$variable),"order"] = "Chaetonotida"
final.melt[grep("Hydra", final.melt$variable),"order"] = "Cnidaria"
final.melt[grep("Dytiscidae|Platambus|Haliplidae|Elmidae|Limnius", final.melt$variable),"order"] = "Coleoptera"
final.melt[grep("Cyclopidae|Acanthocyclops|Cyclopoida|Cyclops|Eucyclops|Mesocyclops", final.melt$variable),"order"] = "Cyclopoida"
final.melt[grep("Chydorus|Daphnia|Polyphemus|Chydoridae|Daphniidae|Diaphanosoma|Eubosmina|Macrothrix|Eurycercus", final.melt$variable),"order"] = "Diplostraca"
...
final.melt[grep("Radix|Potamopyrgus|Stagnicola|Bithynia|Lymnaea|Lymnaeidae|Planorbis|Valvata|Bithyniidae|Theodoxus|Segmentina|Valvatidae", final.melt$variable),"order"] = "Gastropoda"
...
final.melt[grep("Limnesia", final.melt$variable),"order"] = "Trombidiformes"
final.melt[grep("Unio", final.melt$variable),"order"] = "Unionida"
final.melt[grep("Dreissena|Pisidium|Sphaerium", final.melt$variable),"order"] = "Veneroida"

# 23 colours for the Orders
cols_barplot = c("coral1", "chartreuse4","blue","cadetblue1","tan4","burlywood1","brown","blue4","yellow","aquamarine","deeppink","darkviolet","darkslategrey","darkseagreen","darkorchid1","darkorange","darkolivegreen","darkkhaki","red","cyan","grey50","black","steelblue")

png("R_images/summary_barplot_2.png", height=4000, width=4000, units="px", res=300)
