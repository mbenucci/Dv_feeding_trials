...
dva$trial_id = gsub("C${1}","", dva$sample_id)
dvd$trial_id = gsub("C${1}","", dvd$sample_id)
dvc$trial_id = gsub("[.]C${1}","", dvc$sample_id)
...
fa = dva %>% mutate(trial_id = factor(trial_id, levels=c("DvA0","DvA4","DvA8","DvA12","DvA24","DvA36"))) %>% mutate(trial_repl = factor(trial_repl, levels=c("control","1","2","3","4","5"))) %>%
...
fd = dvd %>% mutate(trial_id = factor(trial_id, levels=c("DvD0","DvD4","DvD8","DvD12","DvD24","DvD36"))) %>% mutate(trial_repl = factor(trial_repl, levels=c("control","1","2","3","4","5"))) %>%
...
fc = dvc %>% mutate(trial_id = factor(trial_id, levels=c("DvG0","DvG4","DvG8","DvG12","DvG24","DvG36"))) %>% mutate(trial_repl = factor(trial_repl, levels=c("control","1","2","3","4","5"))) %>%
...
# Asellus
print("DvA - repl 1")
mean(dva[c(dva$trial_repl == 1 & dva$trial_id == "DvA0"), "Asellus_aquaticus"])
sd(dva[c(dva$trial_repl == 1 & dva$trial_id == "DvA0"), "Asellus_aquaticus"])/sqrt(length(dva[c(dva$trial_repl == 1 & dva$trial_id == "DvA0"), "Asellus_aquaticus"]))

mean(dva[c(dva$trial_repl == 1 & dva$trial_id == "DvA4"), "Asellus_aquaticus"])
sd(dva[c(dva$trial_repl == 1 & dva$trial_id == "DvA4"), "Asellus_aquaticus"])/sqrt(length(dva[c(dva$trial_repl == 1 & dva$trial_id == "DvA4"), "Asellus_aquaticus"]))

mean(dva[c(dva$trial_repl == 1 & dva$trial_id == "DvA8"), "Asellus_aquaticus"])
sd(dva[c(dva$trial_repl == 1 & dva$trial_id == "DvA8"), "Asellus_aquaticus"])/sqrt(length(dva[c(dva$trial_repl == 1 & dva$trial_id == "DvA8"), "Asellus_aquaticus"]))

mean(dva[c(dva$trial_repl == 1 & dva$trial_id == "DvA12"), "Asellus_aquaticus"])
sd(dva[c(dva$trial_repl == 1 & dva$trial_id == "DvA12"), "Asellus_aquaticus"])/sqrt(length(dva[c(dva$trial_repl == 1 & dva$trial_id == "DvA12"), "Asellus_aquaticus"]))

mean(dva[c(dva$trial_repl == 1 & dva$trial_id == "DvA24"), "Asellus_aquaticus"])
sd(dva[c(dva$trial_repl == 1 & dva$trial_id == "DvA24"), "Asellus_aquaticus"])/sqrt(length(dva[c(dva$trial_repl == 1 & dva$trial_id == "DvA24"), "Asellus_aquaticus"]))

mean(dva[c(dva$trial_repl == 1 & dva$trial_id == "DvA36"), "Asellus_aquaticus"])
sd(dva[c(dva$trial_repl == 1 & dva$trial_id == "DvA36"), "Asellus_aquaticus"])/sqrt(length(dva[c(dva$trial_repl == 1 & dva$trial_id == "DvA36"), "Asellus_aquaticus"]))

# Asellus replic 2
print("DvA repl 2")
mean(dva[c(dva$trial_repl == 2 & dva$trial_id == "DvA0"), "Asellus_aquaticus"])
sd(dva[c(dva$trial_repl == 2 & dva$trial_id == "DvA0"), "Asellus_aquaticus"])/sqrt(length(dva[c(dva$trial_repl == 2 & dva$trial_id == "DvA0"), "Asellus_aquaticus"]))

mean(dva[c(dva$trial_repl == 2 & dva$trial_id == "DvA4"), "Asellus_aquaticus"])
sd(dva[c(dva$trial_repl == 2 & dva$trial_id == "DvA4"), "Asellus_aquaticus"])/sqrt(length(dva[c(dva$trial_repl == 2 & dva$trial_id == "DvA4"), "Asellus_aquaticus"]))

mean(dva[c(dva$trial_repl == 2 & dva$trial_id == "DvA8"), "Asellus_aquaticus"])
sd(dva[c(dva$trial_repl == 2 & dva$trial_id == "DvA8"), "Asellus_aquaticus"])/sqrt(length(dva[c(dva$trial_repl == 2 & dva$trial_id == "DvA8"), "Asellus_aquaticus"]))

mean(dva[c(dva$trial_repl == 2 & dva$trial_id == "DvA12"), "Asellus_aquaticus"])
sd(dva[c(dva$trial_repl == 2 & dva$trial_id == "DvA12"), "Asellus_aquaticus"])/sqrt(length(dva[c(dva$trial_repl == 2 & dva$trial_id == "DvA12"), "Asellus_aquaticus"]))

mean(dva[c(dva$trial_repl == 2 & dva$trial_id == "DvA24"), "Asellus_aquaticus"])
sd(dva[c(dva$trial_repl == 2 & dva$trial_id == "DvA24"), "Asellus_aquaticus"])/sqrt(length(dva[c(dva$trial_repl == 2 & dva$trial_id == "DvA24"), "Asellus_aquaticus"]))

mean(dva[c(dva$trial_repl == 2 & dva$trial_id == "DvA36"), "Asellus_aquaticus"])
sd(dva[c(dva$trial_repl == 2 & dva$trial_id == "DvA36"), "Asellus_aquaticus"])/sqrt(length(dva[c(dva$trial_repl == 2 & dva$trial_id == "DvA36"), "Asellus_aquaticus"]))

# Asellus replic 4
print("DvA repl 4")
mean(dva[c(dva$trial_repl == 4 & dva$trial_id == "DvA0"), "Asellus_aquaticus"])
sd(dva[c(dva$trial_repl == 4 & dva$trial_id == "DvA0"), "Asellus_aquaticus"])/sqrt(length(dva[c(dva$trial_repl == 4 & dva$trial_id == "DvA0"), "Asellus_aquaticus"]))

mean(dva[c(dva$trial_repl == 4 & dva$trial_id == "DvA4"), "Asellus_aquaticus"])
sd(dva[c(dva$trial_repl == 4 & dva$trial_id == "DvA4"), "Asellus_aquaticus"])/sqrt(length(dva[c(dva$trial_repl == 4 & dva$trial_id == "DvA4"), "Asellus_aquaticus"]))

mean(dva[c(dva$trial_repl == 4 & dva$trial_id == "DvA8"), "Asellus_aquaticus"])
sd(dva[c(dva$trial_repl == 4 & dva$trial_id == "DvA8"), "Asellus_aquaticus"])/sqrt(length(dva[c(dva$trial_repl == 4 & dva$trial_id == "DvA8"), "Asellus_aquaticus"]))

mean(dva[c(dva$trial_repl == 4 & dva$trial_id == "DvA12"), "Asellus_aquaticus"])
sd(dva[c(dva$trial_repl == 4 & dva$trial_id == "DvA12"), "Asellus_aquaticus"])/sqrt(length(dva[c(dva$trial_repl == 4 & dva$trial_id == "DvA12"), "Asellus_aquaticus"]))

mean(dva[c(dva$trial_repl == 4 & dva$trial_id == "DvA24"), "Asellus_aquaticus"])
sd(dva[c(dva$trial_repl == 4 & dva$trial_id == "DvA24"), "Asellus_aquaticus"])/sqrt(length(dva[c(dva$trial_repl == 4 & dva$trial_id == "DvA24"), "Asellus_aquaticus"]))

mean(dva[c(dva$trial_repl == 4 & dva$trial_id == "DvA36"), "Asellus_aquaticus"])
sd(dva[c(dva$trial_repl == 4 & dva$trial_id == "DvA36"), "Asellus_aquaticus"])/sqrt(length(dva[c(dva$trial_repl == 4 & dva$trial_id == "DvA36"), "Asellus_aquaticus"]))
```

```{r PCR replicates distribution Daphnia}
# Daphnia
print("DvD repl 2")
mean(dvd[c(dvd$trial_repl == 2 & dvd$trial_id == "DvD4"), "Daphnia_magna"])
sd(dvd[c(dvd$trial_repl == 2 & dvd$trial_id == "DvD4"), "Daphnia_magna"])/sqrt(length(dvd[c(dvd$trial_repl == 2 & dvd$trial_id == "DvD4"), "Daphnia_magna"]))
```
...
ggplot(trials.melt[trials.melt$variable != "D.villosus",], aes(times, value)) +
  geom_boxplot(outlier.shape=NA) +
  geom_jitter(data=trials.melt[c(trials.melt$value > 0 & trials.melt$variable != "D.villosus"),], aes(times, value, color="red")) +
  geom_jitter(data=trials.melt[c(trials.melt$value == 0 & trials.melt$variable != "D.villosus"),], aes(times, value), alpha=0.4) +
...
dva = dva %>% mutate(trial_id = factor(trial_id, levels=c("DvA0","DvA4","DvA8","DvA12","DvA24","DvA36"))) %>% mutate(trial_repl = factor(trial_repl, levels=c("control","1","2","3","4","5")))

dvd = dvd %>% mutate(trial_id = factor(trial_id, levels=c("DvD0","DvD4","DvD8","DvD12","DvD24","DvD36"))) %>% mutate(trial_repl = factor(trial_repl, levels=c("control","1","2","3","4","5")))

dvc = dvc %>% mutate(trial_id = factor(trial_id, levels=c("DvG0","DvG4","DvG8","DvG12","DvG24","DvG36"))) %>% mutate(trial_repl = factor(trial_repl, levels=c("control","1","2","3","4","5")))
...
fa = ggplot(dva, aes(pcr_repl, Asellus_aquaticus)) +
  geom_point(data=dva[c(dva$Asellus_aquaticus > 0),], inherit.aes=T, color="red") +
  geom_point(data=dva[c(dva$Asellus_aquaticus == 0),], inherit.aes=T, alpha=0.5) +
  labs(x="PCR replicates", y="A. aquaticus DNA reads", subtitle="trials replicates") +
  facet_grid(trial_id~trial_repl) +
  theme_bw() +
...
fd = ggplot(dvd, aes(pcr_repl, Daphnia_magna)) +
 geom_point(data=dvd[c(dvd$Daphnia_magna > 0),], inherit.aes=T, color="red") +
  geom_point(data=dvd[c(dvd$Daphnia_magna == 0),], inherit.aes=T, alpha=0.5) +
  labs(x="PCR replicates", y="D. magna DNA reads", subtitle="trials replicates") +
  facet_grid(trial_id~trial_repl) +
  theme_bw() +
  guides(fill=guide_legend(ncol=1)) +
  theme(legend.position="none", legend.direction ="vertical", axis.text = element_text(size = 15), 
...
fc = ggplot(dvc, aes("1", Crangonyx_pseudogracilis)) +
  geom_point(data=dvc[c(dvc$Crangonyx_pseudogracilis > 0),], inherit.aes=T, color="red") +
  geom_point(data=dvc[c(dvc$Crangonyx_pseudogracilis == 0),], inherit.aes=T, alpha=0.5) +
  labs(x="PCR replicates", y="C. pseudogracilis DNA reads", subtitle="trials replicates") +
  facet_grid(trial_id~trial_repl) +
  theme_bw() +
  guides(fill=guide_legend(ncol=1)) +
  theme(legend.position="none", legend.direction ="vertical", axis.text = element_text(size = 15), 
