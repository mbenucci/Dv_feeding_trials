...
guts$lake = NA
guts[grep("WB", guts$site),"lake"] = "Wroxham Broad"
guts[grep("GW", guts$site),"lake"] = "Grafham Water"
guts[grep("RB", guts$site),"lake"] = "Rockland Broad"
```
...
points(meta.guts, select=which(fact_lake[,1]=="Wroxham Broad"), col="black",pch=19)
points(meta.guts, select=which(fact_lake[,1]=="Grafham Water"), col="blue",pch=15)
points(meta.guts, select=which(fact_lake[,1]=="Rockland Broad"), col="red",pch=17)
...
edna$lake = NA
edna[grep("GW", edna$site),"lake"] = "Grafham Water"
edna[grep("WB", edna$site),"lake"] = "Wroxham Broad"
edna[grep("RB", edna$site),"lake"] = "Rockland Broad"
edna$lake
```
...
points(meta.edna, select=which(fact_elake[,1]=="Wroxham Broad"), col="black",pch=19)
points(meta.edna, select=which(fact_elake[,1]=="Grafham Water"), col="blue",pch=15)
points(meta.edna, select=which(fact_elake[,1]=="Rockland Broad"), col="red",pch=17)
