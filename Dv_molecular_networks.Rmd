...
```{r legend order}
name.multi=c("Cladocera","Amphipoda","Diptera","Hydrozoa","Mollusca","Oligochaeta")
col.multi=c("cyan3","red","yellow","darkcyan","darkorchid3","tan4")
```
...
cols_barplot = c("blue","red","tan4","cyan3","greenyellow","lightskyblue1","yellow","lightpink1","burlywood","deeppink","darkseagreen","darkcyan","palegoldenrod","darkorchid","darkorange","steelblue1","lightcyan1","grey48","darkgreen","khaki3")
